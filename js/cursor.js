...
(function () {
  ...
  function initFollower(first) {
    ...
    const INTERACTIVE =
      'a, button, .btn, .card, .svc, .zoomable, .filter-btn, .work-filter, .work-tile, .work-gallery__nav, .wa-float, .chip, .nav__burger, .lightbox-close, .lightbox-nav, .lightbox-tool, .partner, label, summary';
